...
该命令默认在当前用户的家目录下进行最小规格部署，部署的组件版本默认为最新版本。当前支持组件为：oceanbase-ce、obproxy-ce、obagent、grafana、prometheus、ob-configserver、ocp-express、oblogproxy。

<!-- <main id="notice" type='explain'>
  <h4>说明</h4>
  <p>obd 自 V2.9.0 起支持使用 <code>obd demo</code> 命令部署 ob-configserver、ocp-express 和 oblogproxy 组件。</p>
</main>
