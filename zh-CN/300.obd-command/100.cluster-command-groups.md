...
使用该命令可以对已有租户指定场景调优。对于 OceanBase 数据库 V4.2.x 版本，该命令从 V4.2.5 开始支持；对于 OceanBase 数据库 V4.3.x 版本，该命令从 V4.3.0 开始支持。
