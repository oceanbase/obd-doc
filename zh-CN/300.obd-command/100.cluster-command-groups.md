...
| -i/--interactive  |   否   | bool     | false    | 该选项无需传值，命令中配置即生效。配置该选项执行时，将进入交互式部署流程，具体操作可参见 [交互式部署 OceanBase 集群](../400.user-guide/300.command-line-operations/200.deploy-component/200.start-the-oceanbase-cluster-by-using-obd.md)。  |
