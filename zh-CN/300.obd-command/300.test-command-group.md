...
<main id="notice" type='notice'>
  <h4>注意</h4>
  <p>使用本节命令执行测试时，待测试的集群需是被 obd 管理的集群，否则 obd 无法获取集群的信息。obd 部署的集群默认由 obd 管理，非 obd 部署的集群可执行接管操作进行接管，具体操作可参见 <a href="../400.user-guide/300.command-line-operations/450.takeover-cluster.md">使用 obd 接管集群</a>。</P>
</main>
