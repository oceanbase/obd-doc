...
<main id="notice" type='explain'>
  ...
  <li>
  <p>本节以在线下载 ob-sysbench 为例，若您的机器无法连接外部网络，建议使用可连接外部网络的机器访问 <a href="https://mirrors.oceanbase.com/development-kit/">链接</a>，根据系统版本选择对应版本下载后上传到执行测试的机器。</P>
  </li>
  </ul>
</main>
...
<main id="notice" type='explain'>
  ...
  <li>
  <p>本节以在线下载 obtpch 为例，若您的机器无法连接外部网络，建议使用可连接外部网络的机器访问 <a href="https://mirrors.oceanbase.com/development-kit/">链接</a>，根据系统版本选择对应版本下载后上传到执行测试的机器。</P>
  </li>
  </ul>
</main>
...
<main id="notice" type='explain'>
  ...
  <li>
  <p>本节以在线下载 obtpcc 为例，若您的机器无法连接外部网络，建议使用可连接外部网络的机器访问 <a href="https://mirrors.oceanbase.com/development-kit/">链接</a>，根据系统版本选择对应版本下载后上传到执行测试的机器。</P>
  </li>
  </ul>
</main>
