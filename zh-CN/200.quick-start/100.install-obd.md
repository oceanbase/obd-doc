...
<main id="notice" type='explain'>
  ...
  <li><p>建议通过下载 OceanBase All in One 进行安装，OceanBase All in One 目前提供部署所需要的全部组件（除 obbinlog 组件），且组件已经经过相互适配测试，为官方推荐版本。</p></li>
  </ul>
</main>
...
若通过 RPM 包安装 obd，安装后升级 obd 的操作可参见 [升级 obd](../500.upgrade-obd.md)。
