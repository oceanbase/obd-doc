...
1. 安装 Java，详细步骤可参考 [常见问题](600.faq.md) 中 **如何配置 Java 环境**。
...
解决方法：如需对 OceanBase 数据库企业版使用 Binlog 服务，请部署企业版 Binlog 服务。部署操作可参见 [部署 obbinlog](400.user-guide/300.command-line-operations/200.deploy-component/355.deploy-binlog.md)。
...
解决方法：如需对 OceanBase 数据库社区版使用 Binlog 服务，请部署社区版 Binlog 服务。部署操作可参见 [部署 obbinlog](400.user-guide/300.command-line-operations/200.deploy-component/355.deploy-binlog.md)。
