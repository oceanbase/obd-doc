...
有关 `obd cluster chst` 命令的具体信息请参考 [obd cluster chst](../3.user-guide/3.obd-command/1.cluster-command-groups.md/#obd-cluster-chst)。
...
有关 `obd cluster edit-config` 命令的具体信息请参考 [obd cluster edit-config](../3.user-guide/3.obd-command/1.cluster-command-groups.md/#obd-cluster-edit-config)。
...
有关 `obd cluster reload` 命令的具体信息请参考 [obd cluster reload](../3.user-guide/3.obd-command/1.cluster-command-groups.md/#obd-cluster-reload)。
...
上述为默认风格的配置文件示例，cluster 风格的配置文件请参考 [设置 IDC 信息](../3.user-guide/4.OCP-takeover-OBD-deployment-cluster.md/#设置-idc-信息) 中的配置示例。
...
OCP 要求进程必须是使用 admin 用户启动，且 admin 用户需要有免密 sudo 的权限。因此我们需要准备好可以免密 sudo 的 admin 用户。如果你已经满足此条件可以直接参考 [更改用户](../3.user-guide/4.OCP-takeover-OBD-deployment-cluster.md/#更改用户) 进行操作。
...
有关 `obd cluster restart` 命令的具体信息请参考 [obd cluster restart](../3.user-guide/3.obd-command/1.cluster-command-groups.md/#obd-cluster-restart)。
