...
> **说明**
>
> 本节主要对该命令进行介绍，具体使用请参考 [mysqltest 使用说明](https://www.oceanbase.com/docs/community-observer-cn-10000000000901091)。
...
| --test-server    | 否    | string | 默认为指定的组件下服务器中的第一个节点       | 待测试的机器，后跟 `yaml` 文件中 `servers` 对应的 `name` 值，必须是指定的组件下的某个节点名。                                                                                           |
...
> **说明**
>
> 本节主要对该命令进行介绍，具体使用请参考 [OceanBase 数据库 Sysbench 测试](https://www.oceanbase.com/docs/community-observer-cn-10000000000901379)。
...
| --time                | 否    | int    | 60                           | 总执行时间限制，单位：秒。设置为 `0` 时表示不限制时间。                                                                                     |
...
> **说明**
>
> 本节主要对该命令进行介绍，具体使用请参考 [OceanBase 数据库 TPC-H 测试](https://www.oceanbase.com/docs/community-observer-cn-10000000000901377)。
...
> **说明**
>
> 本节主要对该命令进行介绍，具体使用请参考 [OceanBase 数据库 TPC-C 测试](https://www.oceanbase.com/docs/community-observer-cn-10000000000901381)。
