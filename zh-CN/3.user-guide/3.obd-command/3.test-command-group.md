...
| --psmall-test    | 否    | string | ./mysql_test/psmalltest.py   | psmalltest.py 文件，维护了 psmall 模式的 case。                         |
| --psmall-source  | 否    | string | ./mysql_test/psmallsource.py | psmallsource.py 文件，维护了 psmall 模式下各个 case 的时间限制。                                          |
...
| --log-pattern    | 否    | string | *.log                        | 收集日志的样式。                          |
| --collect-all    | 否    | bool   | false                        | 是否收集组件日志。                        |
