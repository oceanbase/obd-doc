...
* 新增白屏部署命令 `obd web`，详细使用可参见 [通过图形化界面部署 OceanBase 集群](../../400.user-guide/200.ui-operations/200.use-ui-deploy-oceanbase.md)。
...
* 支持部署 OCP Express，详细信息可参见 [使用命令行部署 OCP Express](../../400.user-guide/300.command-line-operations/200.deploy-component/300.deploy-ocp-express-by-using-obd.md)。
