...
* 支持使用 OCP 接管 obd 部署集群，详细介绍可参见 [使用 OCP 接管 obd 部署的集群](../../400.user-guide/300.command-line-operations/400.takeover-cluster/400.OCP-takeover-OBD-deployment-cluster.md)。
