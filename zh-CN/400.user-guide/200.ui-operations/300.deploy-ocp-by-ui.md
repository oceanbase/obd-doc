...
* 部署 OCP 时要求 MetaDB 的版本为 V4.2.1.8，使用全新的 OceanBase 数据库部署 OCP 时需确保 obd 的镜像库中包含 4.2.1.8 版本的 OceanBase 数据库软件包，使用已有 OceanBase 数据库作为 MetaDB 时需确保使用的 OceanBase 数据库版本为 V4.2.1.8。
