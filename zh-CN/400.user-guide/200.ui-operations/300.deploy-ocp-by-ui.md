...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>本文基于 x86 架构的 CentOS Linux 7.9 镜像环境提供操作指导，其他环境可能略有不同。</p>
</main>
...
3. 在操作界面中单击 **开启体验之旅**，在显示的 **欢迎使用 OceanBase 部署向导** 界面选择 **OceanBase 云平台** 模块，将鼠标放置在 **安装** 按钮上，根据显示选择对应安装方式后进入 **欢迎使用 OCP 部署向导** 界面。
   ...
   您可根据实际情况在此界面选择 OCP 安装方式。此处以选择 **使用全新的 OceanBase 数据库** 为例介绍如何使用 obd 部署 OCP，其他详细介绍可参见 《云平台 OCP》中 [部署社区版 OceanBase 云平台](https://www.oceanbase.com/docs/common-ocp-1000000001127036)。
