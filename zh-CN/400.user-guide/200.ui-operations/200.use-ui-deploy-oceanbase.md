...
| 负载类型 | 单击 **类型** 下的下拉框可自行选择 OceanBase 集群的负载类型，不同负载类型下有对应描述，方便了解各类型的适用场景。<main id="notice" type='explain'><h4>说明</h4><p>对于 OceanBase 数据库 V4.2.x 版本，该模块从 V4.2.5 开始支持；对于 OceanBase 数据库 V4.3.x 版本，该模块从 V4.3.0 开始支持。</p></main> |
