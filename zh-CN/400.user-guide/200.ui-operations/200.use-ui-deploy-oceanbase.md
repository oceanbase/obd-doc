...
1. 集群配置
   ...
   | 负载类型 | 单击 **类型** 下的下拉框可自行选择 OceanBase 集群的负载类型，不同负载类型下有对应描述，方便了解各类型的适用场景。<main id="notice" type='explain'><h4>说明</h4><p>该模块仅在待部署的 OceanBase 数据库版本号不小于 V4.2.5 时展示。</p></main> |
