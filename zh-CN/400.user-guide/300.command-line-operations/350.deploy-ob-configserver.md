...
* ob-configserver
  ...
  OceanBase Configserver，简称为 obconfigserver，可提供 OceanBase 的元数据注册，存储和查询服务。详细信息请参见 [ob-configserver](https://github.com/oceanbase/oceanbase/tree/master/tools/ob-configserver)。

## 前提条件

在开始之前，请确保您已满足以下条件：

* 您已安装 V2.3.0 或之后版本的 obd，建议安装最新版本。安装 obd 的详细操作您可参见 [安装 obd](100.install-obd.md)。
