...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <ul>
  <li><p>目前 obd 仅支持管理 Binlog 服务社区版 V4.0.1 及之后版本，和 Binlog 服务企业版 V4.3.2 及之后版本。</p></li>
  <li><p>社区版 Binlog 服务仅支持社区版 OceanBase 数据库，企业版 Binlog 服务仅支持企业版 OceanBase 数据库 MySQL 模式，请根据实际情况部署合适的 obbinlog。</p></li>
  </ul>
</main>
...
* 您的机器中已安装 V3.1.0 或之后版本的 obd，建议安装最新版本，安装操作可参见 [安装 obd](../../../200.quick-start/100.install-obd.md)。
  ...
  <main id="notice" type='explain'>
    <h4>说明</h4>
    <p>obd 自 V4.0.0 起支持部署企业版 obbinlog V4.3.2 及之后版本，如需部署企业版 obbinlog，需安装 V4.0.0 或之后版本的 obd。</p>
  </main>
...
* 您的机器可以联网，或者 obd 本地镜像库中有部署所需安装包。
  ...
  <main id="notice" type='explain'>
    <h4>说明</h4>
    <p>obd 远程镜像库中无企业版 obbinlog 包，如需部署企业版 obbinlog，必须确保 obd 本地镜像库中有部署所需安装包。</p>
  </main>
