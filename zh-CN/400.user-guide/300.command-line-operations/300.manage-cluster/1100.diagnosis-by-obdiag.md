...
<main id="notice" type='explain'>
  ...
  <li>
  <p>本文操作中所用命令的详细介绍可参见官网 <a href="https://www.oceanbase.com/docs/obdiag-cn">OceanBase 敏捷诊断工具（obdiag）</a> 文档。</p>
  </li>
  </ul>
</main>
...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>支持手动编写 task，详细介绍可参见官网 <a href="https://www.oceanbase.com/docs/obdiag-cn">OceanBase 敏捷诊断工具（obdiag）</a> 文档 <b>一键集群巡检</b> 中 <b>task 编写教程</b> 部分内容。</p>
</main>
