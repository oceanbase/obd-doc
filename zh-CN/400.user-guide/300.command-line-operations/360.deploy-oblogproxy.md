...
1. 参考本节步骤添加 oblogproxy 前，您需确认已安装 V2.9.0 或之后版本的 obd。若您环境中 obd 为 V2.9.0 之前版本，可参考 [常见问题](../../500.faq/100.faq.md) 中 **如何升级 obd** 一节升级 obd，也可参考文档 [oblogproxy 安装](https://www.oceanbase.com/docs/community-oblogproxy-doc-1000000000531982) 手动部署。

2. 若 oblogproxy 为 Binlog Service 模式，需要提前部署 OBProxy 和 obconfigserver。
