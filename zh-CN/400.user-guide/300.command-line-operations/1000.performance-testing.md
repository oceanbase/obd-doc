...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>若需要进行性能测试的 OceanBase 集群非使用 OBD 部署，您需先执行接管操作后再参照本文内容进行测试。接管的详细操作可参见 <a href='../300.command-line-operations/450.takeover-cluster.md'>使用 OBD 接管集群</a>。</p>
</main>
...
* OceanBase 数据库：需部署 OceanBase 数据库，并创建执行 TPC-H 测试的租户及用户，请参考 [快速体验 OceanBase 数据库](../../200.quickstart/100.quickly-experience-oceanbase-for-community.md)
...
### 操作步骤
<!-- OBD 一键测试中还创建了脚本，TPCC 和 TPCH 需要创建脚本么 -->
