...
* 分布式部署 + ODP + OCP Express：all-components-min.yaml、all-components.yaml

* 单独部署 OCP Express：ocp-express/ocp-express-only.yaml
...
此处以 `all-components.yaml` 配置文件为例，oceanbase-ce 组件下相关配置如下：
