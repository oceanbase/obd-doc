...
您可参考 OCP 手册中 [修改 Proxyro 账号的密码](https://www.oceanbase.com/docs/community-ocp-cn-10000000001832468) 一文修改 proxyro 账号密码，也可参考如下命令调用 OCP API 进行修改。
...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>OCP V4.0.3 起不支持 curl 命令，若您使用的 OCP 版本为 V4.0.3 及其之后版本，接管过程中遇到问题可联系技术支持同学，或到官网 <a href='https://ask.oceanbase.com/'>问答区</a> 提问，会有专业人员帮忙解决。</p>
</main>
