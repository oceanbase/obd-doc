...
| ocp_monitor_tenant | 必选 | tenant_name: monitor_tenant</b>max_cpu: 1</b>memory_size: 2147483648 | 重新部署  | OCP 监控数据库租户信息。<ul><li>tenant_name：设置 OCP 监控数据库的租户名。</li><li>max_cpu：为 OCP 监控数据库分配的最大 CPU。</li><li>memory_size：为 OCP 监控数据库分配的内存容量。</li></ul>  |
