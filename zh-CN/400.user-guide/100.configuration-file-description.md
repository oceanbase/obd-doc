...
* **scale_out**：该目录下的配置文件示例是为组件变更功能准备的，您可执行相关命令使用这些配置文件添加或移除对应组件。组件变更的操作可参见 [扩容与组件变更](../400.user-guide/300.command-line-operations/900.expansion-and-component-changes.md) 中的 **组件新增** 和 **组件删除**。
  
  <main id="notice" type='explain'>
    <h4>说明</h4>
    <p><b>scale_out<b> 目录下仅提供了部分组件的配置文件示例，目前 OBD 支持所有组件的变更。</p>
  </main>
