...
<main id="notice" type='notice'>
  <h4>Notice</h4>
  <p>To use the commands in this topic to test the performance of a cluster, make sure that the cluster is managed by obd. Otherwise, obd cannot obtain the cluster information. By default, a cluster deployed by using obd is managed by obd. For a cluster not deployed with obd, you first need to use obd to take over the cluster. For more information, see <a href="../400.user-guide/300.command-line-operations/450.takeover-cluster.md">Use obd to take over a cluster</a>. </P>
</main>
