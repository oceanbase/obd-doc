...
This section describes how to specify the installation path and port number of a component. For more information about the parameters in the configuration file, see the **Parameters** section in [Configuration files](../400.user-guide/100.configuration-file-description.md).
