...
You can use this command to display the log details corresponding to the task ID to facilitate log search.
...
The `trace_id` parameter specifies the task ID. After you run another OBD command, the corresponding task ID is generated, and a prompt is displayed to show you how to view the task ID. Example:
