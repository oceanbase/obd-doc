...
* Config Server
   ...
   Config Server allows you to register, store, and query metadata of OceanBase Database. For more information, see [ob-configserver](https://github.com/oceanbase/ob-configserver/tree/main).
