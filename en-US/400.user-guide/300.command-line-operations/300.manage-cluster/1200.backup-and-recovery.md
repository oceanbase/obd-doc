...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <ul>
  <li><p>To use obd commands for backup and restore, make sure that the cluster involved is managed by obd. Otherwise, obd cannot obtain the cluster information. By default, a cluster deployed by using obd is managed by obd. For a cluster not deployed by using obd, you first need to use obd to take over the cluster. For more information, see "Use obd to take over a cluster". </p></li>
  <li>For more information about obd commands used in this topic, see Cluster commands. </li>
  </ul>
</main>
