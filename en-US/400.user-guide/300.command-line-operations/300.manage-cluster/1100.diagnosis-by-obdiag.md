...
<main id="notice" type='explain'>
  ...
  <ul>
  <li>
  <p>To use obd commands to collect diagnostic information of an OceanBase cluster, make sure that the cluster is managed by obd. Otherwise, obd cannot obtain the cluster information. By default, a cluster deployed by using obd is managed by obd. For a cluster not deployed with obd, you first need to use obd to take over the cluster. For more information, see "Use obd to take over a cluster". </p>
  </li>
  <li>
  <p>For more information about the commands used in this topic, see obdiag commands. </p>
  </li>
  </ul>
</main>
...
You can run the `obd obdiag gather` command to collect diagnostic information of an OceanBase cluster. For more information, see the **obd obdiag gather** section in obdiag commands.
