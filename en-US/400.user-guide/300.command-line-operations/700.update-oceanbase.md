...
tab Solution 1: upgrade OceanBase Database online
...
5. Perform a major compaction of OceanBase Database.
   ...
   For more information about the `oceanbase.CDB_OB_MAJOR_COMPACTION` view, see [oceanbase.CDB_OB_MAJOR_COMPACTION](https://en.oceanbase.com/docs/common-oceanbase-database-10000000001972635).
...
tab Solution 2: upgrade OceanBase Database offline
