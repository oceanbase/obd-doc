...
* OceanBase Database: Deploy OceanBase Database and create a tenant and a user for the test. For more information about how to deploy OceanBase Database, see **Deploy an OceanBase cluster on the GUI**. You can run the `obd cluster tenant create` command to create a tenant. For more information, see the **obd cluster tenant create** section in [Cluster commands](../../300.obd-command/100.cluster-command-groups.md).
