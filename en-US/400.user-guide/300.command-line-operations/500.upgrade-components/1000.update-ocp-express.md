...
* The version of OceanBase Deployer (obd) is V2.1.0 or later. If the version of OCP Express is V4.2.1 or later, that of obd must be V2.3.1 or later. If the obd you are using is earlier than V2.0.0, upgrade the obd by referring to [Upgrade obd](../../../500.upgrade-obd.md).
...
tab obtain the hash value online
...
tab obtain the hash value offline
