...
<main id="notice" type='explain'>
  ...
  <ul>
  <li>
  <p>For more information, see <a href="../../200.quick-start/300.use-ui-deploy-oceanbase.md">Deploy an OceanBase cluster on the GUI of obd</a>. </p>
  </li>
  <li>
  <p>For more information about how to deploy a multi-node cluster by using obd, see the OceanBase database documentation <a href="https://en.oceanbase.com/docs/common-oceanbase-database-10000000001104023">Deploy OceanBase Database in a production environment by using the CLI</a> in OceanBase Database Documentation. </p>
  </li>
  </ul>
</main>
