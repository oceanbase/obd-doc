...
2. Add oblogproxy.
   ...
   In this example, the target cluster is named `obtest`. You must replace the cluster name with the actual one. For more information about the `obd cluster component add` command, see Cluster commands.
