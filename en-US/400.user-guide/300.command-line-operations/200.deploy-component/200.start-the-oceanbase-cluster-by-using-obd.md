...
<main id="notice" type='explain'>
  ...
  <ul>
  <li>
  <p>For more information about how to deploy an OceanBase cluster on the GUI of obd, see <a href="../../../400.user-guide/200.ui-operations/200.use-ui-deploy-oceanbase.md">Deploy an OceanBase cluster on the GUI</a>. </p>
  </li>
  <li>
  <p>For more information about how to deploy a multi-node cluster by using obd, see <a href="https://en.oceanbase.com/docs/common-oceanbase-database-10000000001971618">Deploy OceanBase Database in a production environment by using the CLI</a>. </p>
  </li>
  </ul>
</main>
