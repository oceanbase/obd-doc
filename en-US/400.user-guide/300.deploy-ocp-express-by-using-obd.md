...
* The version of OceanBase Deployer (OBD) is V2.0.0 or later. If the version of OBD in your environment is earlier than V2.0.0, upgrade OBD. For more information, see **How do I upgrade OBD?** in [FAQ](../500.faq/100.faq.md).
...
* If OBD is installed by using the all-in-one package, you can view the sample configuration file provided by OBD in the `~/.oceanbase-all-in-one/conf` directory.
...
2. Create a meta tenant, a user, and a database for OCP Express, and grant the user the required privileges.
   ...
   1. Create a meta tenant.
      ...
      You can also log in to OceanBase Database to create a tenant for OCP Express. For more information, see [Create a user tenant](https://www.oceanbase.com/docs/community-observer-cn-0000000000965467).
...
1. Create a meta tenant.
   ...
   You can also log in to OceanBase Database to create a tenant for OCP Express. For detailed instructions, see [Create a user tenant](https://www.oceanbase.com/docs/community-observer-cn-0000000000965467).
