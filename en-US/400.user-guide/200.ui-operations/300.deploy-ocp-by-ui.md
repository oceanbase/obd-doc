...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>The following describes the procedure for deploying OCP on a CentOS Linux 7.9 system based on the x86 architecture as an example. Please note that the GUI may differ depending on the version of obd being used. </p>
</main>
