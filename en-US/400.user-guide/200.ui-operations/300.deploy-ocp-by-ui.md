...
* The disk space available on the server for deployment meets the requirement. For more information, see [Disk and directory planning](https://en.oceanbase.com/docs/common-ocp-10000000001704590).
