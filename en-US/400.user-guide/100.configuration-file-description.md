...
* **scale_out**: The sample configuration files in this directory are intended for scale-out and component changes. You can run related commands to scale out components or add or remove a component by using corresponding configuration files. For more information, see [Scale out a cluster and change cluster components](../400.user-guide/300.command-line-operations/900.expansion-and-component-changes.md).
  ...
  <main id="notice" type='explain'>
    <h4>Note</h4>
    <p>The <b>scale_out</b> directory stores only the sample configuration files of some components. Note that obd supports changes of all components and scale-out of all components other than oblogproxy. </p>
  </main>
