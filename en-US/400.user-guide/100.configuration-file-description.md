...
| `all-components-min.yaml`/`all-components.yaml` | Sample configuration files for OceanBase Database distributed deployment and all other components. | OceanBase Database, ODP, OBAgent, OCP Express, obconfigserver, Prometheus, and Grafana |
