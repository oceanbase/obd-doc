...
|servers        |Yes                                                                                                                                                              |None                                  |You can specify the information of each server in the `- name: server name(line break)ip: server IP address` or `- <ip>` format, where `- <ip>` is equivalent to `- name: server IP address(line break)ip: server IP address`.|
