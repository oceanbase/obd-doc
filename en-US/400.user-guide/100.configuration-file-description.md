...
* Config Server
   ...
   Config Server allows you to register, store, and query the metadata of OceanBase Database. For more information, see [ob-configserver](https://github.com/oceanbase/ob-configserver/tree/main).
...
| `all-components-min.yaml`/`all-components.yaml` | Sample configuration files for OceanBase Database distributed deployment and all other components. | OceanBase Database, ODP, OBAgent, OCP Express, Config Server, oblogproxy, Prometheus, and Grafana |
...
* **oblogproxy**: The sample configuration files in this folder are intended for deploying oblogproxy. You can use these sample configuration files to deploy oblogproxy separately or deploy OceanBase Database, ODP, Config Server, and oblogproxy together.
