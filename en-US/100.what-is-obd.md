...
OceanBase Deployer (obd) is a tool for installing and deploying OceanBase clusters. obd allows you to deploy an OceanBase cluster on the CLI or GUI and provides a standardized configuration process to simplify cluster deployment. For more information, see [Deploy OceanBase Database on a single OBServer node](400.user-guide/300.command-line-operations/200.deploy-component/200.start-the-oceanbase-cluster-by-using-obd.md) and [Deploy an OceanBase cluster on the GUI](400.user-guide/200.ui-operations/200.use-ui-deploy-oceanbase.md).
