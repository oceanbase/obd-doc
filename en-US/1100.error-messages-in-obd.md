...
Solution: Run the `obd cluster component add <deploy_name> -c <ob-configserver.config>` command to deploy obconfigserver. For more information, see the **Add a component** section in [Scale out a cluster and change cluster components](400.user-guide/300.command-line-operations/900.expansion-and-component-changes.md).
