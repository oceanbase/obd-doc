...
3. If the error `operation not permitted` occurs, check the privileges of the ping file. You can try executing the command `sudo chmod u+s /usr/bin/ping` to modify the privileges of the ping file.
