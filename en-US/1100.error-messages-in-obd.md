...
Solution: Run the `obd cluster edit-config <deploy name>` command to open the configuration file. Add or change the password and run the restart command provided in the output.
