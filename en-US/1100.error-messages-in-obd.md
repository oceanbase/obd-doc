...
<main id="notice" type='notice'>
  <h4>Notice</h4>
  <p>After modifying the <code>admin_passwd</code> parameter, you must run the <code>obd cluster redeploy</code> command to destroy and redeploy the cluster. The modification takes effect once you redeploy the cluster. The data in the cluster will be lost. Therefore, back up the data before you run the command. </p>
</main>
