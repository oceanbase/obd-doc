...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>This topic describes how to quickly deploy OceanBase Database for experience. For information about how to deploy OceanBase Database in the production environment, see **Deploy an OceanBase cluster on the GUI**.</p>
</main>
