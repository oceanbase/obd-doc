...
| Optional components | By default, only ODP is selected. You can deselect the components that you do not want to deploy under **Components**. You can also click **Learn More** in the row of a component to view its documentation. <main id="notice" type='explain'><h4>Note</h4><p>OCP Express is selected along with OBAgent automatically. When you deselect OBAgent, OCP Express is automatically deselected. </p></main> |
