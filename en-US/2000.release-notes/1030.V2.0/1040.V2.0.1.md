...
This version supports the upgrade of OceanBase Cloud Platform (OCP) Express by using the `obd cluster reinstall` command. For more information, see Upgrade OCP Express.
