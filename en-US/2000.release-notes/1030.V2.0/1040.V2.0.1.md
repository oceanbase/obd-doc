...
This version supports the upgrade of OceanBase Cloud Platform (OCP) Express by using the `obd cluster reinstall` command. For more information, see [Upgrade OCP Express](../../400.user-guide/300.command-line-operations/500.upgrade-components/1000.update-ocp-express.md).
