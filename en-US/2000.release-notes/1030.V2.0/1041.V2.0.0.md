...
* This version provides the `obd web` command for you to perform obd GUI-based deployment. For more information, see [Deploy an OceanBase cluster on the GUI](../../400.user-guide/200.ui-operations/200.use-ui-deploy-oceanbase.md).
...
* This version supports the deployment of OceanBase Cloud Platform (OCP) Express. For more information, see [Deploy OCP Express by using commands](../../400.user-guide/300.command-line-operations/200.deploy-component/300.deploy-ocp-express-by-using-obd.md).
