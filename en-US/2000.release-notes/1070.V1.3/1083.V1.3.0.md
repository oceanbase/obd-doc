...
* This version allows OceanBase Cloud Platform (OCP) to take over OceanBase clusters deployed by using obd. For more information, see [Use OCP to take over a cluster deployed by obd](../../400.user-guide/300.command-line-operations/400.takeover-cluster/400.OCP-takeover-OBD-deployment-cluster.md).
