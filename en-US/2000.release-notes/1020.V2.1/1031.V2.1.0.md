...
* This version supports the upgrade of OceanBase Database Community Edition from V4.0 to V4.1. For more information, see [Upgrade OceanBase Database](../../400.user-guide/300.command-line-operations/500.upgrade-components/700.update-oceanbase.md).

* This version supports the deployment of OceanBase Cloud Platform (OCP) Express V1.0.1 and the upgrade of OCP Express. For more information, see [Upgrade OCP Express](../../400.user-guide/300.command-line-operations/500.upgrade-components/1000.update-ocp-express.md).
