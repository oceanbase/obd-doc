...
* Changing components in a deployed cluster is supported. For more information about the commands, see the **obd cluster component add** and **obd cluster component del** sections in the Cluster commands topic. For more information about the operations, see Scale out a cluster and change cluster components.

* Scale-out of all components except OCP-Server is supported. For more information about the commands, see the **obd cluster scale_out** section in the Cluster commands topic. For more information about the operations, see Scale out a cluster and change cluster components.

* The oblogproxy component is supported. For more information, see Deploy oblogproxy by using the CLI.
