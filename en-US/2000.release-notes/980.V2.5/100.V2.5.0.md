...
* Changing components in a deployed cluster is supported. For more information about the commands, see the **obd cluster component add** and **obd cluster component del** sections in the [Cluster commands](../../300.obd-command/100.cluster-command-groups.md) topic. For more information about the operations, see [Scale out a cluster and change cluster components](../../400.user-guide/300.command-line-operations/300.manage-cluster/900.expansion-and-component-changes.md).
...
* The oblogproxy component is supported. For more information, see [Deploy oblogproxy by using the CLI](../../400.user-guide/300.command-line-operations/200.deploy-component/360.deploy-oblogproxy.md).
